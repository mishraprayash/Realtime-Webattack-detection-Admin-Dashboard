...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle  text-black   [&:has([role=checkbox])]:pr-0 dark:text-neutral-400 bg-blue-300 border border-black " ,
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-4 align-middle [&:has([role=checkbox])]:pr-0 border border-black", className)}
    {...props}
  />
))
